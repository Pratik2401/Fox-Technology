...
function addMember() {
    ...
    $.ajax({
        ...
        error: function(xhr) {
            const errorMsg = xhr.responseJSON?.error || 'Error adding member';
...
function addBook() {
    ...
    $.ajax({
        ...
        error: function(xhr) {
            const errorMsg = xhr.responseJSON?.error || 'Error adding book';
            Swal.fire('Error!', errorMsg, 'error');
        }
    });
}
...
function issueBook() {
    ...
    $.ajax({
        ...
        error: function(xhr) {
            const errorMsg = xhr.responseJSON?.error || 'Error issuing book';
            Swal.fire('Error!', errorMsg, 'error');
        }
    });
}